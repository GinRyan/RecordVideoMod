 ...
 */
public class PreviewScalableVideoView extends TextureView implements TextureView.SurfaceTextureListener,
        MediaPlayer.OnVideoSizeChangedListener {

    protected MediaPlayer mMediaPlayer;
    protected ScalableType mScalableType = ScalableType.NONE;

    public PreviewScalableVideoView(Context context) {
        this(context, null);
    }

    public PreviewScalableVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PreviewScalableVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDetachedFromWindow() {
        ...
        mMediaPlayer = null;
        if (onDetachedAction != null) {
            onDetachedAction.onDetached(mMediaPlayer, this);
        }
    }
...
//        mMediaPlayer = new MediaPlayer();
    ...
    public PreviewScalableVideoView setOnDetachedAction(OnDetachedAction onDetachedAction) {
        this.onDetachedAction = onDetachedAction;
        return this;
    }

    public PreviewScalableVideoView setOnAttachedAction(OnAttachedAction onAttachedAction) {
        this.onAttachedAction = onAttachedAction;
        return this;
    }

    OnDetachedAction onDetachedAction;
    OnAttachedAction onAttachedAction;

    public static interface OnDetachedAction {
        public void onDetached(MediaPlayer mp, PreviewScalableVideoView v);
    }

    public static interface OnAttachedAction {
        public void onAttached(MediaPlayer mp, PreviewScalableVideoView v);
    }
}
